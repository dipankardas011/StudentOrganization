...
public class App extends studentDatabase.Request.User {
    ...
    public App() {
        super();
        try {
            this.conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/students?user=root&password=Dipsonu@11");
